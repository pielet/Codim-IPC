...
if __name__ == "__main__":
    ...
    sim.add_shell_3D("input/square" + size + ".obj", Vector3d(0, sim.cloth_thickness[clothI] + 0.001, 0), \
    ...
    if algI == 0:
        ...
        sim.initialize(sim.cloth_density_iso[clothI], sim.cloth_Ebase_iso[clothI] * membEMult,
            sim.cloth_nubase_iso[clothI], sim.cloth_thickness_iso[clothI], 0) # 0 means having gravity
