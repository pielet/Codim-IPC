...
if __name__ == "__main__":
    ...
    sim.add_motion(0, 1.0, DBC_range, Vector3d(0, 0, 0), Vector3d(0, 0, 0), Vector3d(0, 1, 0), 180)
    sim.add_motion(1.0, 2.0, DBC_range, Vector3d(0, 0, 0), Vector3d(0, 0, 0), Vector3d(0, 1, 0), -180)
